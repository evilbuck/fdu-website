        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {personas.map((persona, index) => (
            <Link
              key={index}
              href={persona.href}
              className="group block bg-[#F8FAFC] rounded-xl p-6 hover:bg-[#1B365D] transition-all duration-300"
            >
              {/* Icon */}
              <div className="w-12 h-12 rounded-lg bg-[#1B365D] group-hover:bg-[#FF6B35] flex items-center justify-center mb-4 transition-colors">
